...
const ADMIN_ICONS = {
  ...
  ticket: `
    <span class="nav-icon ni ni-adm-ticket">
      <svg viewBox="0 0 24 24"><path d="M3 9h4v6H3V9z"/><path d="M17 9h4v6h-4V9z"/><path d="M7 7h10v10H7V7z"/><circle cx="12" cy="12" r="1.5"/></svg>
    </span>`,
  attendance: `
...
function injectAdminStyles() {
  ...
  style.textContent = `
    ...
    .nav-item.active .ni-adm-ticket     { box-shadow: 0 6px 20px rgba(56,189,248,.68), inset 0 1px 1px rgba(255,255,255,.25), inset 0 -2px 4px rgba(0,0,0,.3); }
...
function injectSidebar() {
  ...
  <aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
      ...
      <a href="tickets.html"      class="nav-item">${ADMIN_ICONS.ticket}      Ticket Requests</a>
